...
contract TestToken {
  ...
  function beforeAll() public {
      address firstAddress = 0x627306090abaB3A6e1400e9345bC60c78a8BEf57;
      address secondAddress = 0xf17f52151EbEF6C7334FAD080c5704D77216b732;
      address thirdAddress = 0xC5fdf4076b8F3A5357c5E395ab970B5B54098Fef;
      address forthAddress = 0x821aEa9a577a9b44299B9c15c88cf3087F3b5544;
      address fithAddress = 0x0d1d4e623D10F9FBA5Db95830F7d3839406C6AF2;
  ...
  function testDistrubute() public {
      ...
      Assert.equal(token.balanceOf(firstAddress),supplyAmount/token.getTotalUsers,"Tokens should be the total supply over total amount");
